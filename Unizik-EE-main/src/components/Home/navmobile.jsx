...
const abooutUs = () => {
  ...
  <Link to='/' className="flex items-center relative z-[20] flex- gap-1">
            ...
            <h1 className="uppercase text-[25px] text-slate-50 "><span className="font-myfont">GVU</span><span className="font-[900] text-yellow-500">-</span><span className="font-myfont">PQS</span></h1>
          </Link>
          </div>
        ...
        <li className="bg-slate-900  text-slate-50 px-[5px] py-[5px] text-[15px] rounded capitaliz font-[700] ">
                          ...
                          Academics { !acedemicsDisplay? <IoIosArrowDropdownCircle/> : <IoIosArrowDropupCircle/>}
                           ...
                           {acedemicsDisplay && <ul className="absolute z-[1000] capitalize rounded shadow-2xl z-1  font-poppins    p-2 text-slate-900 bg-slate-50 flex flex-col gap-2">
                              <li><Link onClick={() => hidenavF()} to='/Academics/Learning-resources' className="text-[15px] text-slate-900 hover:text-slate-700 ">Learning Resources</Link></li>
